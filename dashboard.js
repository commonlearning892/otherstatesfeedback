...
fetch('feedback_stats.json?v=' + Date.now())
    ...
    .then(data => {
        ...
        try { renderSegmentTotalsGrid(); renderSegmentCountsGrid(); renderSegmentYNMChart(); renderSegmentOverallChart(); } catch(e) { console.error('Direct segment render error:', e); }
    })
    .catch(error => {
...
function renderAllSections(viewData) {
    ...
    try { renderSegmentTotalsGrid(); renderSegmentCountsGrid(); renderSegmentYNMChart(); renderSegmentOverallChart(); } catch (e) { console.error('Segment render error:', e); }
}
